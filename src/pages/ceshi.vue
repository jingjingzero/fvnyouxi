...
`,
    ...
    title: "异界结晶",
    content: `
  <p>是一种彻底超出本世界认知体系的异常存在，它并非自然生成，也无法被判定为任何已知文明的造物，更像是从外太空或者未知世界的产物。它内部持续稳定散发着强烈的光芒。</p>
  <p>奥米集团对异界结晶进行了长达数十年的研究，最终确认它并非单纯意义上的坚硬，而是完全不受本世界规则约束。无论是高温熔炼、极限加压、异能攻击，还是量子级分解，都无法对其造成任何破坏。结晶内部蕴含着难以估量的能量反应，却既不能被提取，也无法被转化。</p>
  <p>真正令异界结晶被列为最高级别不可控异常物的，是它对异能者产生的绝对性影响。任何异能者只要被结晶散发的光芒照耀，能力便会在瞬间彻底失效，无论能力类型、强度或来源如何，均无法激活、维持或释放，这种现象被称为“绝对平等”。</p>
  <p>奥米集团内部仍在继续研究其中的谜团，目前将其当作镇压与管控异能者的手段。</p>
`,
  },
];
